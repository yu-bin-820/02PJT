...
<table width="100%" border="0" cellspacing="0" cellpadding="0"	style="margin-top: 13px;">
	...
	<tr>
		...
		<tr>
			...
			<td bgcolor="D6D6D6" width="1"></td>
			<% if(vo.getPaymentOption().trim().equals("1")){ %>
			<td class="ct_write01">현금구매</td>
			<% }if(vo.getPaymentOption().trim().equals("2")){ %>
		...
		<tr>
			...
			<td class="ct_write01">
				<table border="0" cellspacing="0" cellpadding="0">
					<tr>
						<td height="26"><%=vo.getDivyAddr() %></td>
					</tr>
				</table>
			</td>
		</tr>
		...
		<tr>
			...
			<td class="ct_write01">
				<table border="0" cellspacing="0" cellpadding="0">
					<tr>
						<td height="26"><%=vo.getDivyRequest() %></td>
					</tr>
				</table>
			</td>
		</tr>
				...
				<table border="0" cellspacing="0" cellpadding="0">
					<tr>
						...
						<td background="/images/ct_btnbg02.gif" class="ct_btn01"
							...
							href="/updatePurchaseView.do?tranNo=<%=vo.getTranNo()%>">수정</a></td>
